...
test('generated values', () => {
  ...
  expect(results).toMatchInlineSnapshot(`
    Object {
      ...
      "email": Array [
        "Tyson_Will8387@emasculateprose.net",
        "Hardy.Daniel4512@flawed-schoolhouse.info",
        "Uriah_Mertz5449@creoliseradish.name",
        "Filomena_Leannon4271@appropriate-anesthesiologist.net",
        "Lurline_Goyette9874@betraymole.biz",
        "Cathy.McLaughlin1572@overdue-memo.net",
        "Erna_Lueilwitz9497@impassioned-rate.com",
        "Lloyd.Block2116@worldly-aperitif.net",
        "Alec_Cummings1823@barricadegratitude.com",
        "Irma.Hudson530@swearmoment.biz",
      ],
      "firstName": Array [
        "Marvin",
        "Horace",
